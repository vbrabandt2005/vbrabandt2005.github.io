...
- **OS for Desktops:** [Ubuntu](https://ubuntu.com/desktop), [Kubuntu](https://kubuntu.org), [EndeavourOS](https://endeavouros.com) or [Arch Linux](https://archlinux.org)
- **OS for Laptops:** [Ubuntu](https://ubuntu.com/desktop), [Kubuntu](https://kubuntu.org) or [EndeavourOS](https://endeavouros.com)
...
- [Pacstall](https://pacstall.dev/), AUR for Debain/Ubuntu-based distros
...
And I mean [Audacity](https://www.audacityteam.org/) (or [Tenacity](https://tenacityaudio.org/)) dispite all their flaws are still a must have as a basic DAW, both are open-source, with Tenacity being a fork of Audacity with telemetry and weird stuff removed.

My current tryout list are Logic & [Bitwig](https://www.bitwig.com).
