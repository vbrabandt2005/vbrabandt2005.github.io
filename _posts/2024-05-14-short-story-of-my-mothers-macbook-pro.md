...
I imagine that if full Vulkan support for the iGPU would ever be implemented or WineD3D would performance improve, maybe this MacBook could reach even higher protential than native Windows itself.
